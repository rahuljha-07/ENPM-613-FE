...
function EditCoursePageContent() {
  ...
  const handleSubmitModule = async () => {
    ...
    try {
      const response = await fetch(
        `${BASE_URL}/instructor/course/${courseId}/add-module`,
        {
          method: "POST",
          headers: {
  ...
  const confirmDeleteModule = async () => {
    ...
    try {
      const response = await fetch(
        `${BASE_URL}/instructor/delete-module/${moduleToDelete}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleSubmitVideo = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${BASE_URL}/instructor/module/${moduleIdForVideo}/add-video`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const confirmDeleteVideo = async () => {
    ...
    try {
      const response = await fetch(
        `${BASE_URL}/instructor/delete-video/${videoToDelete}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleSubmitQuiz = async () => {
    ...
    try {
      const response = await fetch(
        `${BASE_URL}/instructor/module/${moduleIdForQuiz}/add-quiz`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const confirmDeleteQuiz = async () => {
    ...
    try {
      const response = await fetch(
        `${BASE_URL}/instructor/delete-quiz/${quizToDelete}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleSubmitCourse = async () => {
    ...
    try {
      const response = await fetch(
        `${BASE_URL}/instructor/course/${courseId}/submit-for-approval`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleEditCourseSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${BASE_URL}/instructor/update-course/${courseId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
      ...
      if (response.ok) {
        ...
        const errorData = await response.json();
        toast.error(
          `Failed to update course: ${errorData.message || response.statusText}`
        );
      }
    } catch (error) {
                              ...
                              <div>
                                <div className="flex justify-between items-center">
                                  ...
                                  <button
                                    className="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition duration-300"
                                    onClick={() =>
                                      handleDeleteVideo(item.video.id)
                                    }
                                  >
                                    Delete Video
                                  </button>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-30">
            <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full relative">
              ...
              <div className="mb-4">
                ...
                <label className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors cursor-pointer flex items-center">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M15 10l4.553-2.276A2 2 0 0122 8.618v6.764a2 2 0 01-2.447 1.902L15 14m0 0l-4.553 2.276A2 2 0 018 16.382V9.618a2 2 0 012.447-1.902L15 10z"
                    />
                  </svg>
                  Select Video
                  <input
                ...
                {videoFile && (
                  <p className="mt-2 text-sm text-gray-700">{videoFile.name}</p>
                )}
              </div>
              <div className="mb-4">
                <label className="block text-gray-700 mb-2">
                  Upload Transcript (.SRT format)
                </label>
                <label className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors cursor-pointer flex items-center">
                  {/* Transcript Icon */}
                  <svg
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M9 17v-2a2 2 0 012-2h4a2 2 0 012 2v2m-6-6h6m-6 4h6m-6-8h6m-6 4h6"
                    />
                  </svg>
                  Select Transcript
                  <input
                    ...
                    <div key={idx} className="flex items-center mb-1">
                      ...
                      <label className="flex items-center">
                        <input
                          ...
                          onChange={() =>
                            handleOptionChange(idx, !option.isCorrect)
                          }
                          className="mr-1"
                        />
                        Correct
